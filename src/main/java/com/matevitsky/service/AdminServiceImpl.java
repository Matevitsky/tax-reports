...
public class AdminServiceImpl implements AdminService {
    ...
    private final RequestInspectorChangeRepository requestInspectorChangeRepository;
    private final RequestService requestService;
    private final ClientRepository clientRepository;
    private final InspectorService inspectorService;
    private final ClientService clientService;

    public AdminServiceImpl(RequestInspectorChangeRepository requestInspectorChangeRepository,
                            RequestService requestService, ClientRepository clientRepository,
                            InspectorService inspectorService, ClientService clientService) {
